...
const Navbar: React.FC = () => {
  ...
  const handlePageChange = (page: string) => {
    setActivePage(page);
    setIsOpen(true); // Menutup navbar setelah memilih halaman
  };
      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className={`w-full md:w-auto ${isOpen ? '' : 'hidden'} md:block`} id="navbar-default">
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a href="/" className={`block py-2 px-3 rounded md:p-0 dark:text-white md:dark:text-blue-500 ${activePage === 'Home' ? 'text-gray-900 md:text-blue-700 md:p-0 dark:text-white' : 'hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent'}`} aria-current="page" onClick={() => handlePageChange('Home')}>Home</a>
            </li>
            <li>
              <a href="/about" className={`block py-2 px-3 rounded md:p-0 dark:text-white md:dark:text-blue-500 ${activePage === 'About' ? 'text-blue-700 md:text-blue-700 md:p-0 dark:text-white' : 'hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent'}`} aria-current="page" onClick={() => handlePageChange('About')}>About Us</a>
            </li>
            <li>
              <a href="/services" className={`block py-2 px-3 rounded md:p-0 dark:text-white md:dark:text-blue-500 ${activePage === 'Services' ? 'text-blue-700 md:text-blue-700 md:p-0 dark:text-white' : 'hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent'}`} aria-current="page" onClick={() => handlePageChange('Services')}>Services</a>
            </li>
            <li>
